...
public class MemberManager {
    ...
    // 2. 사용자 전체 조회
    private void viewAllMember(MemberDao dao) throws SQLException {
    ...
    private void updateMember(Scanner sc, MemberDao dao) throws SQLException {
        ...
        System.out.println("사용자의 새이름 (변경하지 않으려면 Enter)");
    ...
    private void deleteMember(Scanner sc, MemberDao dao) throws SQLException {
        System.out.println("삭제할 사용자 ID 입릭: ");
        int id = Integer.parseInt(sc.nextLine());
